...
`000_full_database_bootstrap.sql` is the **collapsed final state** of files #1–#34 (#33 and #34 are
folded verbatim as §20/§21 — a fresh install must NOT re-run them). Where an object is
